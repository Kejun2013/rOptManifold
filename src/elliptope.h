#ifndef ELLIPTOPE_CLASS
#define ELLIPTOPE_CLASS

#include "manifold.h"

//quotient version of grassmann manifold

class elliptope: public manifold
{
private:
  arma::colvec retract_a;
  arma::colvec alphas;
  arma::mat eGrad;// the Euclidean gradient
public:
  elliptope(int, int, int, NumericMatrix,int);
